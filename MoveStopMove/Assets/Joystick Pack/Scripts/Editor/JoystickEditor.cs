...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty fixedXY;
    ...
    protected virtual void OnEnable()
    {
        ...
        fixedXY = serializedObject.FindProperty("fixedXY");
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(fixedXY, new GUIContent("fixed XY", "XY Around circle R = 1"));
    }
